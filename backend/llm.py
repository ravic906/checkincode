...
def audit_problem_quality(
    *,
    ...
    system_prompt = (
        ...
        "quotes around it, or because it \"isn't valid JSON\" -- every "
        "single correct example on this platform looks exactly like that "
        "and none of those are defects. The ONLY real defects to flag "
